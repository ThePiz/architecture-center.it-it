        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Motore di ricerca di prodotti intelligente per l'e-commerce</h3>
                        <p>Fornire un'esperienza di ricerca di qualità elevata in un'applicazione di e-commerce.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>IoT e analisi dei dati nell'industria edilizia</h3>
                        <p>Usare dispositivi IoT e analisi dei dati per offrire una gestione e un funzionamento completo dei progetti edilizi.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Data warehousing e analitica per vendite e marketing</h3>
                        <p>Consolidare i dati da più origini e ottimizzare le analisi dei dati.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Inserimento ed elaborazione in tempo reale dei dati IoT per il settore automobilistico</h3>
                        <p>Inserire ed elaborare in tempo reale i dati dei veicoli con l'IoT.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Accelerare la modellazione basata su immagini digitali in Azure</h3>
                        <p>Accelerare la modellazione basata su immagini digitali in Azure con Avere e Agisoft PhotoScan</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Desktop virtuali Linux con Citrix</h3>
