...
![Diagramma di un database di documenti](./images/graph.png)
...
Servizio di Azure pertinente: [archivio BLOB][blob]
...
Servizio di Azure pertinente: [archivio file][file-storage]
