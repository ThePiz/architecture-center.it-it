...
3. Per `sharedKey`, immettere una chiave condivisa per la connessione VPN. 
...
5. Usare il comando `ping` per testare la connettività alle macchine virtuali jumpbox in ogni spoke:
