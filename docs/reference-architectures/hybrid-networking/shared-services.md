...
3. Ripetere il passaggio 1 precedente per il file `spoke2.json`.

4. Eseguire `azbb` per distribuire l'ambiente della seconda rete virtuale spoke, come illustrato di seguito.
