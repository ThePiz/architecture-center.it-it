...
Questa architettura si basa su quella illustrata in [Eseguire una macchina virtuale Windows in Azure][single vm]. Le raccomandazioni riportate in questo riferimento si applicano anche a questa architettura.
