---
title: Carichi di lavoro della macchina virtuale Windows
...
# <a name="windows-vm-workloads"></a>Carichi di lavoro della macchina virtuale Windows

Queste architetture di riferimento mostrano procedure comprovate per l'esecuzione di macchine virtuali Windows in Azure.
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Indicazioni di base per l'esecuzione di tutte le macchine virtuali Windows in Azure.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Macchine virtuali configurate per un'applicazione a più livelli con SQL Server.</p>
                    </div>
                </div>
            </div>
        </div>
