---
title: Architetture di riferimento per la rete perimetrale
...
# <a name="network-dmz-reference-architectures"></a>Architetture di riferimento per la rete perimetrale
