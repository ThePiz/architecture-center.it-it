...
Per consigli specifici sull'implementazione di Active Directory in Azure, vedere [estensione di Active Directory Domain Services (AD DS) in Azure][adds-extend-domain].
