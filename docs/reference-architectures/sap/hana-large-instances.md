...
- SAP Note [2121330][sap-2121330] - Domande frequenti: SAP BW on HANA sizing report (Nota SAP 2121330: domande frequenti: report sul ridimensionamento di SAP BW in HANA)
...
- I dati in transito tra istanze Large di HANA e le macchine virtuali non vengono crittografati. Per crittografare i dati trasferiti, abilitare le funzioni di crittografia specifiche dell'applicazione. Vedere SAP Note [2159014][sap-2159014] - Domande frequenti: SAP HANA Security (Nota SAP 2159014 - domande frequenti: sicurezza SAP HANA).
