...
4. In **Ruolo** selezionare **Proprietario**.
5. Digitare l'indirizzo e-mail dell'utente che si vuole aggiungere come proprietario.
6. Selezionare l'utente e fare clic su **Salva**.
...
2. Eseguire SetupKeyVault.ps nel modo seguente:
