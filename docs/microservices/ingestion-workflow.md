...
> Un metodo di richiesta viene considerato "idempotente" se l'effetto previsto sul server di più richieste identiche con tale metodo è uguale all'effetto di una singola richiesta ([RFC 7231](https://tools.ietf.org/html/rfc7231#section-4)).
