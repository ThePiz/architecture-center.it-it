...
- Per un confronto di CQRS con altri stili di architettura, vedere [Stili di architettura](/azure/architecture/guide/architecture-styles/) e [Stile di architettura CQRS](/azure/architecture/guide/architecture-styles/cqrs).
