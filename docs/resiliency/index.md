...
- Contratto di servizio combinato per due aree = (1 &minus; (1 &minus; 0,9995) ^ 2) = 99,999975%
- Contratto di servizio combinato per quattro aree = (1 &minus; (1 &minus; 0,9995) ^ 4) = 99,999999%
