...
Contoso deve creare un'app line-of-business e un'app rivolta ai clienti. Ha deciso di eseguire le app in Azure. Dave legge l'articolo relativo alla [governance normativa delle sottoscrizioni](azure-scaffold.md) e ora è pronto a mettere in atto le indicazioni.
