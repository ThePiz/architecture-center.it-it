            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Microsoft Cloud Adoption Framework per Azure</h3>
                            <p>Un processo per la creazione di una strategia di adozione del cloud a livello di organizzazione, incentrata su criteri, governance e infrastruttura.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>HPC (High Performance Computing) in Azure</h3>
                            <p>Linee guida sulla progettazione e informazioni sui componenti per lo sviluppo di applicazioni HPC (High Performance Computing) in Azure.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> Concetti fondamentali per un'architettura di Azure efficiente</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> Progettare per la sicurezza in Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Progettare per prestazioni e scalabilità in Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Progettare per efficienza e operazioni in Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Progettare per disponibilità e recuperabilità in Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visualizzare una presentazione dello stile di architettura a più livelli</h3>
                    </div>
                </div>
            </div>
        </div>
